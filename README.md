...
A **roadmap first collection of free and legal AI resources**: courses, books, papers, tools, APIs, labs, and communities, ordered so you learn in the right sequence.
